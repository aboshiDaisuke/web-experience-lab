...
トップは制作依頼につなげるためのポートフォリオです。ヒーロー（11作品を印刷した紙が降ってきて束になり、いちばん上をつまんで投げると次の作品が現れる）→ 作品一覧（目的別の絞り込み・カードから作品へ）→ できること → 料金の目安 → 制作の流れ・FAQ → 相談フォーム、の順に並びます。各作品ページ右下からも、その作品を引き継いで相談フォームへ移動できます（`/?ref=<slug>#contact`）。
...
CASA MIRAI（戸建て）と MIRAI HILLS 目黒（分譲マンション・11作品目）は、Blenderで作った住まいを歩いて内覧できます。
